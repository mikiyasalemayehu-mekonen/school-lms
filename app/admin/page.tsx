...
async function RenderRecentCourses() {
  ...
  if (data.length === 0) {
    return (
      <EmptyState buttonText="Create A New Course" description="You DOnt have any courses, Create Some to see them here."
      title="You dont have any courses yet." href="/admin/courses/create"/>
    );
  }
  return (

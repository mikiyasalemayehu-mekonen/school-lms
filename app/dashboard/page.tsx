    ...
    <>
      <div className="flex flex-col gap-2">
        ...
        {enrolledCourses.length===0 ?(
          <EmptyState  title="No courses Purchased" description="You have not purchase ant courses yet" buttonText="Browse Courses" href="/courses"/>
        ...
        {courses.filter(
          ...
          <EmptyState  title="No courses Available" description="All courses are already purchased" buttonText="Browse Courses" href="/courses"/>
        ):(
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {courses.filter(
          (course)=>!enrolledCourses.some(({

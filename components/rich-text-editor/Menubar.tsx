    ...
    <TooltipProvider>
      ...
      <div className="flex flex-wrap gap-1">
          ...
          <TooltipTrigger asChild>
            <Toggle
              size="sm"
              pressed={editor.isActive("textAlign", { alignment: "left" })}
              onPressedChange={() =>
                editor.chain().focus().setTextAlign("left").run()
              }
              className={cn(
                editor.isActive("textAlign", { alignment: "left" }) && "bg-muted text-muted-foreground"
              )}
            >
              <AlignLeft />
            </Toggle>
          ...
          <TooltipTrigger asChild>
            <Toggle
              size="sm"
              pressed={editor.isActive("textAlign", { alignment: "center" })}
              onPressedChange={() =>
                editor.chain().focus().setTextAlign("center").run()
              }
              className={cn(
                editor.isActive("textAlign", { alignment: "center" }) && "bg-muted text-muted-foreground"
              )}
            >
              <AlignCenter />
            </Toggle>
          ...
          <TooltipTrigger asChild>
            <Toggle
              size="sm"
              pressed={editor.isActive("textAlign", { alignment: "right" })}
              onPressedChange={() =>
                editor.chain().focus().setTextAlign("right").run()
              }
              className={cn(
                editor.isActive("textAlign", { alignment: "right" }) && "bg-muted text-muted-foreground"
              )}
            >
              <AlignRight />
            </Toggle>
